...
Feature: Admin OES lite portal - para Para_Para_Impairment_Groups scenarios
  ...
  Scenario: To Verify the "Para Impairment Groups" option page
  ...
  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the "Create Para Impairment Groups" without enter the name fields
    And Create Para Impairment Groups without enter the name fields

  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the "Create Para Impairment Groups" without enter the code fields
    And Create Para Impairment Groups without enter the code fields

  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the "Create Para Impairment Groups" disable "Action" toggle
    And Create Para Impairment Groups disable Action toggle

  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the "Create Para Impairment Groups" cancel the popup window
    And Create Para Impairment Groups cancel the popup window

  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the "Edit Para Impairment Groups" from data table
    And Edit Para Impairment Groups from data table

  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the "Edit Para Impairment Groups" from data table using edit name field
    And Edit Para Impairment Groups from data table using edit name field

  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the "Edit Para Impairment Groups" from data table using edit Code  field
    And Edit Para Impairment Groups from data table using edit Code field

  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the "Edit Para Impairment Groups" from data table using edit both name and Code  field
    And Edit Para Impairment Groups from data table using edit both name and Code  field

  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the "Edit Para Impairment Groups" from data table using edit Active status
    And Edit Para Impairment Groups from data table using edit Active status

  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the "Edit Para Impairment Groups" from data table using empty value for name field
    And Edit Para Impairment Groups from data table using empty value for name field

  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the "Edit Para Impairment Groups" from data table using empty value for Code field
    And Edit Para Impairment Groups from data table using empty value for Code field

  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the "Edit Para Impairment Groups" from data table using empty value for both Name and Code field
    And Edit Para Impairment Groups from data table using empty value for both Name and Code field

  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the "Edit Para Impairment Groups" from data table click on cancel button
    And Edit Para Impairment Groups from data table click on cancel button

  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the search field in the Para Impairment Groups data table
    And search field in the Para Impairment Groups data table

  @WTT_OVR_Lite_Admin_portal_TS008
  Scenario: To Verify the "Delete Para Impairment Groups" from data table
